 ...
 */
final class Version20200317142010 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__trajet AS SELECT id, conducteur_id, point_depart_id, point_arrivee_id, temps_trajet, prix, nb_places, vehicule, options FROM trajet');
        ...
        , date_trajet DATE NOT NULL, CONSTRAINT FK_2B5BA98CF16F4AC6 FOREIGN KEY (conducteur_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2B5BA98CD2C9B65 FOREIGN KEY (point_depart_id) REFERENCES destination (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2B5BA98C36855DE8 FOREIGN KEY (point_arrivee_id) REFERENCES destination (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO trajet (id, conducteur_id, point_depart_id, point_arrivee_id, temps_trajet, prix, nb_places, vehicule, options) SELECT id, conducteur_id, point_depart_id, point_arrivee_id, temps_trajet, prix, nb_places, vehicule, options FROM __temp__trajet');
