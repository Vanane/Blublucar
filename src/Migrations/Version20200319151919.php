 ...
 */
final class Version20200319151919 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE trajet (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, conducteur_id INTEGER NOT NULL, point_depart_id INTEGER NOT NULL, point_arrivee_id INTEGER NOT NULL, temps_trajet INTEGER DEFAULT NULL, prix DOUBLE PRECISION NOT NULL, nb_places INTEGER NOT NULL, vehicule VARCHAR(255) NOT NULL COLLATE BINARY, date DATETIME NOT NULL, options CLOB DEFAULT NULL --(DC2Type:array)
        , CONSTRAINT FK_2B5BA98CF16F4AC6 FOREIGN KEY (conducteur_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2B5BA98CD2C9B65 FOREIGN KEY (point_depart_id) REFERENCES destination (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2B5BA98C36855DE8 FOREIGN KEY (point_arrivee_id) REFERENCES destination (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__trajet AS SELECT id, conducteur_id, point_depart_id, point_arrivee_id, temps_trajet, prix, nb_places, vehicule, options, date FROM trajet');
        $this->addSql('DROP TABLE trajet');
        $this->addSql('CREATE TABLE trajet (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, conducteur_id INTEGER NOT NULL, point_depart_id INTEGER NOT NULL, point_arrivee_id INTEGER NOT NULL, temps_trajet INTEGER DEFAULT NULL, prix DOUBLE PRECISION NOT NULL, nb_places INTEGER NOT NULL, vehicule VARCHAR(255) NOT NULL, date DATETIME NOT NULL, options CLOB DEFAULT \'NULL --(DC2Type:array)\' COLLATE BINARY --(DC2Type:array)
        )');
        $this->addSql('INSERT INTO trajet (id, conducteur_id, point_depart_id, point_arrivee_id, temps_trajet, prix, nb_places, vehicule, options, date) SELECT id, conducteur_id, point_depart_id, point_arrivee_id, temps_trajet, prix, nb_places, vehicule, options, date FROM __temp__trajet');
        $this->addSql('DROP TABLE __temp__trajet');
        $this->addSql('CREATE INDEX IDX_2B5BA98CF16F4AC6 ON trajet (conducteur_id)');
